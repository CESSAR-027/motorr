                ...
                <div className='container mx-auto'>
                   <div className='flex items-center justify-between'>
                        ...
                        flex flex-col justify-center items-start'>
                          ...
                          <p className='mb-10 text-lg max-w-[508px] mx-auto text-center
                          xl:text-left xl:mx-0'>
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nisi porro sunt eligendi aperiam hic ut nihil ipsam quibusdam accusamus minima, facilis voluptas rem fuga dolores dignissimos ratione commodi debitis laboriosam.
                          </p>
                          {/* btn group */}
